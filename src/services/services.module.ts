...
@Module({
  imports:[MongooseModule.forFeature([{name:Services.name,schema:ServicesSchema}]),JsonwebtokenModule,MongooseModule.forFeature([{name:LogsSys.name,schema:LogsSysSchema}])],
